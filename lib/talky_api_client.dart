...
class TalkyApiClient {
  ...
  static const String baseUrl   = 'https://158.220.107.211/tmp/api';
  static const String socketUrl = 'https://158.220.107.211/tmp/';
  // Test local E2EE (backend local via `adb reverse tcp:3000 tcp:3000`) :
